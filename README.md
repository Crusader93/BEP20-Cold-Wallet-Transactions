...
<br/>
How it works:<br/>
We will create a transaction on a device with Internet access, and we will sign the exported transaction with a private key on a device without Internet access, then we will import this transaction to the our online device and send transaction to the blockchain.<br/>
...
4. Export the private key (private_key) to the script on offline device '2-BNB-OFFLINE-SIGN-TRANSACTION.py'<br/>
